...
const Footer = ({ data }) => {
  ...
  const staticSocialLink = [
    { iconName: "facebook", iconUrl: "https://facebook.com/scottmail77" },
    // { iconName: 'twitter', iconUrl: 'https://twitter.com/'  },
    {
      iconName: "instagram",
      iconUrl: "https://www.instagram.com/_scottwalters",
    },
      ...
      <div className="wrapper">
        ...
        <div className="footer__bottom">
          {copyrightText ? (
            ...
            <div className="copyright-text">ScottW 2020</div>
          )}
...
Footer.defaultProps = {
  copyrightText: `ScottW ${new Date().getFullYear()}`,
}
